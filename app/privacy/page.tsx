  ...
  return (
    <main className={`${styles.shell} standalone-route`}>
      <article>
        ...
        <section>
          <h2>1. 수집하는 정보</h2>
          <p>로그인 시 계정 식별에 필요한 치지직 채널 ID만 처리하며, 사용자 닉네임과 로그인 시도 이력은 저장하지 않습니다. 서비스 이용 과정에서 사용자가 고른 스트리머 목록, 알림 설정, 푸시 구독 정보와 제안 내용이 저장될 수 있습니다.</p>
        ...
        <section>
          <h2>4. 외부 서비스</h2>
          <p>서비스 제공과 익명 이용 통계 집계를 위해 Vercel을, 앱 알림 전송을 위해 Expo 및 Apple·Google의 푸시 알림 서비스를, 방송·채널 정보 확인과 계정 로그인을 위해 치지직 공식 API를 이용합니다. 각 사업자는 서비스 제공에 필요한 범위에서 정보를 처리할 수 있습니다.</p>
        </section>
        <section>
          <h2>5. 이용자의 선택</h2>
